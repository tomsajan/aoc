...
if __name__ == '__main__':
    ...
    t.root.get_size()
    print(sizes)
    taken_space = (max(sizes))
    free_space = disk_size - taken_space
    print(free_space)
    to_free_up = wanted_space - free_space
    print(to_free_up)
    candidates = [i for i in sizes if i >= to_free_up]
    print(min(candidates))
    submit(min(candidates))
